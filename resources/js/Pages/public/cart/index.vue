            ...
            <div class="relative flex items-center justify-center text-white bg-center bg-no-repeat bg-cover"
                ...
                <div class="z-10 flex flex-col items-center justify-center p-4 text-center">
                    ...
                    <h1
                        ...
                        <span
                            class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">CARRITO DE COMPRAS </span>
                    </h1>
          ...
          <ul role="list" class="border-t border-b border-gray-200 divide-y divide-gray-200">
            <li class="flex py-6 sm:py-10">
              <div class="flex-shrink-0">
                <img src="https://tailwindui.com/img/ecommerce-images/shopping-cart-page-01-product-01.jpg" alt="Front of men&#039;s Basic Tee in sienna." class="object-cover object-center w-24 h-24 rounded-md sm:h-48 sm:w-48">
              </div>
                ...
                <div class="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                  <div>
                    ...
                    <div class="flex mt-1 text-sm">
                      ...
                      <p class="pl-4 ml-4 text-gray-500 border-l border-gray-200">Large</p>
                    </div>
            ...
            <li class="flex py-6 sm:py-10">
              <div class="flex-shrink-0">
                <img src="https://tailwindui.com/img/ecommerce-images/shopping-cart-page-01-product-02.jpg" alt="Front of men&#039;s Basic Tee in black." class="object-cover object-center w-24 h-24 rounded-md sm:h-48 sm:w-48">
              </div>
            ...
            <li class="flex py-6 sm:py-10">
              <div class="flex-shrink-0">
                <img src="https://tailwindui.com/img/ecommerce-images/shopping-cart-page-01-product-03.jpg" alt="Insulated bottle with white base and black snap lid." class="object-cover object-center w-24 h-24 rounded-md sm:h-48 sm:w-48">
              </div>
